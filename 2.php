...
<font size="5"><font color="red">2.The probability of passing an exam is 0.0001, then detemine the chances that more than three students out of 3000 will pass the exam</font><br>

<div ><font size="3" > <br><div class="d00"><input type="radio" name="b" value="d"></div><div class="border border-dark button1 s"> <input type="button"class="btn btn-primary btn-lg btn-block"value="A         0.7"> </div>
<br><div class="d0"><input type="radio" name="b" value="d"></div><div class="border border-dark button1 s2"><input type="button" class="btn btn-primary btn-lg btn-block " value="B           0.6" > </div>
 <br><div class="d"><input type="radio" name="b" value="0"></div><div class="border border-dark button1 s3"><input type="button" class="btn btn-primary btn-lg btn-block "value="C          0.3"></div>
 <br><div class="d2"><input type="radio" name="b" value="0.48"></div><div class="border border-dark button1 s4"><input type="button"class="btn btn-primary btn-lg btn-block " value="D         0.48" ></div>
