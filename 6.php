...
<font size="5"><font color="red">6.A dice s rolled 180 times ,find the probability tht face 4 will turn up atleast 35 times (it is a normal distribution and p in z(0,1)=0.3413)</font><br>

<div ><font size="3" > <br><div class="d00"><input type="radio" name="f" value="d"></div><div class="border border-dark button1 s"> <input type="button"class="btn btn-primary btn-lg btn-block"value="A         0.147"> </div>
<br><div class="d0"><input type="radio" name="f" value="d"></div><div class="border border-dark button1 s2"><input type="button" class="btn btn-primary btn-lg btn-block " value="B           0.6" > </div>
 <br><div class="d"><input type="radio" name="f" value="3"></div><div class="border border-dark button1 s3"><input type="button" class="btn btn-primary btn-lg btn-block "value="C          0.3"></div>
 <br><div class="d2"><input type="radio" name="f" value="0.158"></div><div class="border border-dark button1 s4"><input type="button"class="btn btn-primary btn-lg btn-block " value="D         0.158" ></div>
...
<input type="submit" class="new" value="SUBMIT EXAM">
 ...
 <a href="7.php"><button type="button" class="bb">SAVE and NEXT</button></a>