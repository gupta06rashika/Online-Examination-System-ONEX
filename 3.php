...
<font size="5"><font color="red">3.The probability of 53 Sundays in a leap year?</font><br>

<div ><font size="3" > <br><div class="d00"><input type="radio" name="c" value="d"></div><div class="border border-dark button1 s"> <input type="button"class="btn btn-primary btn-lg btn-block"value="A          6/7"> </div>
<br><div class="d0"><input type="radio" name="c" value="d"></div><div class="border border-dark button1 s2"><input type="button" class="btn btn-primary btn-lg btn-block " value="B           1/7" > </div>
 <br><div class="d"><input type="radio" name="c" value="2/7"></div><div class="border border-dark button1 s3"><input type="button" class="btn btn-primary btn-lg btn-block "value="C           2/7"></div>
 <br><div class="d2"><input type="radio" name="c" value="d"></div><div class="border border-dark button1 s4"><input type="button"class="btn btn-primary btn-lg btn-block " value="D           5/7" ></div>
...
<input type="submit" class="new" value="SUBMIT EXAM">
 ...
 <a href="4.php"><button type="button" class="bb">SAVE and NEXT</button></a>