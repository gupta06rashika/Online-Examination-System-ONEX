...
<div><div font="5px"><div id="clockdiv"></div></font></div>
<script> 
...
<font size="5"><font color="red">5.Given X is B(n,p)if E(X)=9 , VAR(X)=4.2 then n is? (in rupees)</font><br>

<div ><font size="3" > <br><div class="d00"><input type="radio" name="e" value="0"></div><div class="border border-dark button1 s"> <input type="button"class="btn btn-primary btn-lg btn-block"value="A         30"> </div>
<br><div class="d0"><input type="radio" name="e" value="d"></div><div class="border border-dark button1 s2"><input type="button" class="btn btn-primary btn-lg btn-block " value="B           10" > </div>
 <br><div class="d"><input type="radio" name="e" value="20"></div><div class="border border-dark button1 s3"><input type="button" class="btn btn-primary btn-lg btn-block "value="C          20"></div>
 <br><div class="d2"><input type="radio" name="e" value="d"></div><div class="border border-dark button1 s4"><input type="button"class="btn btn-primary btn-lg btn-block " value="D         50" ></div>
...
<input type="submit" class="new" value="SUBMIT EXAM">
 ...
 <a href="6.php"><button type="button" class="bb">SAVE and NEXT</button></a>