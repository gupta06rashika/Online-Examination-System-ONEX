...
<font size="5"><font color="red">9.What is the probability of getting more than one tail ,given that at least one coin is head when 4 coins are tossed?</font><br>

<div ><font size="3" > <br><div class="d00"><input type="radio" name="i" value="d"></div><div class="border border-dark button1 s"> <input type="button"class="btn btn-primary btn-lg btn-block"value="A         0.7"> </div>
<br><div class="d0"><input type="radio" name="i" value="d"></div><div class="border border-dark button1 s2"><input type="button" class="btn btn-primary btn-lg btn-block " value="B           0.6" > </div>
 <br><div class="d"><input type="radio" name="i" value="0.3"></div><div class="border border-dark button1 s3"><input type="button" class="btn btn-primary btn-lg btn-block "value="C          0.3"></div>
 <br><div class="d2"><input type="radio" name="i" value="2/3"></div><div class="border border-dark button1 s4"><input type="button"class="btn btn-primary btn-lg btn-block " value="D         2/3" ></div>
...
<input type="submit" class="new" value="SUBMIT EXAM">
 ...
 <a href="10.php"><button type="button" class="bb">NEXT</button></a>
