...
<font size="5"><font color="red">4.The probability density function of normal distribution of a random variable X is <br> f(x)=K/\e(-((x/\2)/50)+4x-200) What is the sum of mean and standard deviation </font><br>

<div ><font size="3" > <br><div class="d00"><input type="radio" name="d" value="d"></div><div class="border border-dark button1 s"> <input type="button"class="btn btn-primary btn-lg btn-block"value="A         100"> </div>
<br><div class="d0"><input type="radio" name="d" value="105"></div><div class="border border-dark button1 s2"><input type="button" class="btn btn-primary btn-lg btn-block " value="B           105" > </div>
 <br><div class="d"><input type="radio" name="d" value="0.3"></div><div class="border border-dark button1 s3"><input type="button" class="btn btn-primary btn-lg btn-block "value="C          125"></div>
 <br><div class="d2"><input type="radio" name="d" value="d"></div><div class="border border-dark button1 s4"><input type="button"class="btn btn-primary btn-lg btn-block " value="D         150" ></div>
...
<input type="submit" class="new" value="SUBMIT EXAM">
 ...
 <a href="5.php"><button type="button" class="bb">NEXT</button></a>