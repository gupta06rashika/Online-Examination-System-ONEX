...
<font size="5"><font color="red">8.A pair of dice is thrown .Find the probabity of obtaining a sum of 8 or getting an evan no. on both the dice. (in rupees)</font><br>

<div ><font size="3" > <br><div class="d00"><input type="radio" name="h" value="d"></div><div class="border border-dark button1 s"> <input type="button"class="btn btn-primary btn-lg btn-block"value="A         0.7"> </div>
<br><div class="d0"><input type="radio" name="h" value="d"></div><div class="border border-dark button1 s2"><input type="button" class="btn btn-primary btn-lg btn-block " value="B           0.6" > </div>
 <br><div class="d"><input type="radio" name="h" value="11/36"></div><div class="border border-dark button1 s3"><input type="button" class="btn btn-primary btn-lg btn-block "value="C          11/36"></div>
 <br><div class="d2"><input type="radio" name="h" value="d"></div><div class="border border-dark button1 s4"><input type="button"class="btn btn-primary btn-lg btn-block " value="D         0.5" ></div>
...
<input type="submit" class="new" value="SUBMIT EXAM">
 ...
 <a href="9.php"><button type="button" class="bb">SAVE and NEXT</button></a>